...
namespace lemon{
	...
	template<size_t Size,size_t Align> 
	struct aligned_storage_selector<Size,Align,int,false>
	{
		typedef typename aligned_storage_selector<Size,Align,int>::type type;
	};

	template<size_t Size,size_t Align> 
	struct aligned_storage_selector<Size,Align,short,false>
	{
		typedef typename aligned_storage_selector<Size,Align,short>::type type;
	};
